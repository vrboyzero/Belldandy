...
export class MCPToolBridge {
    ...
    constructor(callToolFn, usePrefix = true) {
     ...
     */
    toBelldandyTools() {
        return Array.from(this.bridgedTools.values()).map((tool) => this.createBelldandyTool(tool));
    }
    /**
     * 获取指定服务器的工具定义
     *
     ...
     * @returns 工具调用结果
     */
    async callTool(bridgedName, args) {
