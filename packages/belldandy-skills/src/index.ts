...
export { imageGenerateTool, textToSpeechTool, cameraSnapTool, synthesizeSpeech } from "./builtin/multimedia/index.js";
export type { SynthesizeResult, SynthesizeOptions } from "./builtin/multimedia/index.js";
