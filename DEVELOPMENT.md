...
本文档详细介绍了 Belldandy 项目已完成的功能模块及后续规划，旨在帮助开发者和使用者深入理解系统设计与能力。同时，为了方便对比与参考，附录部分详细列出了参考目标 **moltbot** 的完整能力清单。
...
| **插件系统** | ✅ 丰富 | ✅ 核心架构 | Hook/Registry 已就绪 |
...
### 🎯 推荐下一步优先级
 ...
 5. **`sessions_spawn` (子 Agent 编排)** — 赋予 Agent 团队作战能力（Phase 16）
 6. **`canvas` / `code_interpreter` (Stateful)** — 更高级的创造与计算能力
